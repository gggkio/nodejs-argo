...
const UUID = process.env.UUID || '243976d1-13ce-4dcf-870f-db4f2bf58fbc'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'nezha.future10000.eu.org';        // 哪吒v1填写形式: nz.abc.com:8008  哪吒v0填写形式：nz.abc.com
const NEZHA_PORT = process.env.NEZHA_PORT || '443';            // 使用哪吒v1请留空，哪吒v0需填写
const NEZHA_KEY = process.env.NEZHA_KEY || 'a2ckLQIRomQf7Lx9v8';              // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
